...
public class IHMTestEnsembleTests extends junit.framework.TestCase{
    ...
    public void test_IHMTestEnsemble_union() throws Exception{
        ...
        assertEquals(" IHM a-t-elle ete modifiee ?", components.length, 4);

        // la bonne IHM
        assertTrue(" IHM a-t-elle ete modifiee ?", components[0] instanceof JPanel);
        assertTrue(" IHM a-t-elle ete modifiee ?", components[1] instanceof JPanel);
        assertTrue(" IHM a-t-elle ete modifiee ?", components[2] instanceof JPanel);
        assertTrue(" IHM a-t-elle ete modifiee ?", components[3] instanceof JPanel);

        Component[] subComponents = ((JPanel)components[2]).getComponents();
        assertTrue(" IHM a-t-elle ete modifiee ?", subComponents[1] instanceof JButton);// union
        assertTrue(" IHM a-t-elle ete modifiee ?", subComponents[2] instanceof JButton);// inter
        assertTrue(" IHM a-t-elle ete modifiee ?", subComponents[3] instanceof JButton);// diff
        assertTrue(" IHM a-t-elle ete modifiee ?", subComponents[4] instanceof JButton);// diffSym
