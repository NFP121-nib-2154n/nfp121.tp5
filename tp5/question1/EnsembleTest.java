...
public class EnsembleTest extends junit.framework.TestCase {
	...
	public void testAdd() {//q1-2
        ...
        assertEquals(false, e1.add(2));//d?j? ajouter
        assertEquals(2, e1.size());
    ...
    /**
     * Tests de la m?thode intersection dans la classe Ensemble. 
     */
    ...
    /**
     * Tests de la m?thode diff?rence dans la classe Ensemble. 
     */
    ...
    /**
     * test de la m?thode diff?rence sym?trique dans la classe Ensemble. 
     */
